...
rel=stylesheet type=text/css href="${ctx }/css/style.css">
...
<TABLE class=house-list>
  <TBODY>
  <TR>
    <TD class=house-thumb><SPAN><A href="details.htm" target="_blank"><img src="${ctx }/images/thumb_house.gif" width="100" height="75" alt=""></A></SPAN></TD>
    <TD>
      <DL>
